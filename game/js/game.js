const songs = [
	...
	},
	{
		...
		lyrics:
			"Ah ha ha. Oh yeah. Work. Somebody told me, boy everything she wants is everything she sees. I guess I must've loved you because I said you were the perfect girl for me, baby. And now we're six months older and everything you want and everything you see, is out of reach not good enough. I don't know what the hell you want from me, oh. Somebody tell me, won't you tell me, why I work so hard for you. ",
...
window.addEventListener("DOMContentLoaded", () => {
	...
	function showRingoOverlay(ratingCount) {
		...
		text.textContent = `You got ${ratingCount} Ringo Starr${
			ratingCount === 1 ? "" : "'s"
		}`;
