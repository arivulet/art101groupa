window.songs = [
	{
		...
		albumArt:"images/Lady_Gaga_and_Bruno_Mars_-_Die_with_a_Smile.png",
		startTime:"0.0",
	},
	{
		id: "feeling",
	...
	},
	{
		id: "infinity",
		title:
			"Infinity Repeating (2013 Demo) - Daft Punk feat. Julian Casablancas + The Voidz",
		lyrics:
	...
	},
	{
		...
		lyrics:
			"Come home, come here Come out and let me breathe, oh, let me breathe now Come home, come here Come out and let me breathe, let me breathe, oh-woah And I pray that my jealousy don't turn into evil And I pray that the world doesn't shape up my ego I pray that my jealousy don't turn into evil And I pray that the world doesn't shape up my ego",
	...
	},
	{
		...
		lyrics:
			"Every time you lie in my place I do want to say It's you you my babe It won't be too late oh don't leave me behind Without you, I'll cry 'Cause only you, my baby Only you can conquer time Only you can conquer time",
	...
	},
	{
		...
		lyrics:
			"So come on, come on, dark star, been loving you and I Can't get enough, dark star, we don't need Brazzers Feel the world around you, feel the world surround you Feel the world around you, feel it all around you crash",
...
function loadSong(song) {
	...
	function showRingoRating() {
		...
		headsDiv.innerHTML = "";
		countDiv.textContent = `You got ${ringos} ${
			ringos === 1 ? "Ringo Starr" : "Ringo Starrs"
		}!`;
...
function startCountdownAndPlay(player) {
	...
	const interval = setInterval(() => {
		...
		if (countdown > 0) {
			...
			if (songId === "dontclick") {
				setTimeout(() => {
					document.getElementById("lyrics-display").style.visibility =
						"visible";
...
window.addEventListener("DOMContentLoaded", () => {
	...
	const player = document.getElementById("player");
	document
		.getElementById("choose-light")
		.addEventListener("click", () => applyTheme("light"));
	document
		.getElementById("choose-dark")
	...
	if (toggleBtn) {
		toggleBtn.addEventListener("click", () => {
			const currentTheme = document.body.classList.contains("darkmode")
				? "dark"
				: "light";
